(function() {
  ...
  var details = [
    ...
    },
    {
      ...
      "endDate":"2015,8,28",
      "headline":"Shippable",
      "text":"<i>Software Engineering Intern:</i><br/>Worked in a group of 4 front and back-end interns and helped in post-development fixes and changes for the Shippable 3.0 platform, used Angular and Node, working on multi-stack.",
      "asset":
      {
